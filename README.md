...
| **17** | 33 | Защита | **Защита итоговых проектов (Часть 1).** | Доклад, ответы на вопросы. |
| | 34 | Защита | **Защита итоговых проектов (Часть 2).** | Доклад, ответы на вопросы. |
| **18** | 35 | Защита | **Защита итоговых проектов (Часть 3).** | Доклад, ответы на вопросы. |
| | 36 | Защита | **Защита итоговых проектов (Часть 4).** | Доклад, ответы на вопросы, подведение итогов. |
